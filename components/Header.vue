    ...
    <div class="header-top">
      <div class="container">
        <div class="header-top__inner">
          ...
          <div class="auth">
            <nuxt-link class="auth__login login" to="/auth/login">
              <p class="login__text">Войти</p>
              <img
                class="login__icon"
                src="~/assets/images/icons/user-placeholder.svg"
                alt="user"
              />
            </nuxt-link>
          </div>
        ...
        <div class="header-menu__inner">
          <nuxt-link class="catalog" to="/catalog">
            <button class="catalog__btn">
              <img
                class="catalog__img"
                src="~/assets/images/icons/catalog.svg"
                alt=""
              />
          ...
          <div class="info">
            ...
            <div class="info__item">
              <svg
                class="info__icon-cart icon-cart"
                width="21"
                height="26"
                viewBox="0 0 21 26"
                fill="none"
